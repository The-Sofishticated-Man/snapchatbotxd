...
# time.sleep(4)
client = Client()
client.login("hmaloney2024", "mal51159")
client.loadVictims()
client.victims[0].sendMessage("hi there my name is hmaloney2024")
client.victims[1].sendMessage("hi there my name is john cena ")